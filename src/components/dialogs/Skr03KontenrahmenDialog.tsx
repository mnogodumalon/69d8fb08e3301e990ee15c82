...
interface Skr03KontenrahmenDialogProps {
  open: boolean;
  onClose: () => void;
  onSubmit: (fields: Skr03Kontenrahmen['fields']) => Promise<void>;
  defaultValues?: Skr03Kontenrahmen['fields'];
  enablePhotoScan?: boolean;
  enablePhotoLocation?: boolean;
}

export function Skr03KontenrahmenDialog({ open, onClose, onSubmit, defaultValues, enablePhotoScan = true, enablePhotoLocation = true }: Skr03KontenrahmenDialogProps) {
  const [fields, setFields] = useState<Partial<Skr03Kontenrahmen['fields']>>({});
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    setSaving(true);
    try {
      const clean = cleanFieldsForApi({ ...fields }, 'skr03_kontenrahmen');
      await onSubmit(clean as Skr03Kontenrahmen['fields']);
      onClose();
    } finally {
      setSaving(false);
    }
  ...
  async function handlePhotoScan(file: File) {
    ...
    try {
      ...
      const schema = `{\n  "kontonummer": string | null, // Kontonummer (SKR03)\n  "kontobezeichnung": string | null, // Kontobezeichnung\n  "kontenklasse": LookupValue | null, // Kontenklasse (select one key: "klasse_0" | "klasse_1" | "klasse_2" | "klasse_3" | "klasse_4" | "klasse_5" | "klasse_6" | "klasse_7" | "klasse_8" | "klasse_9") mapping: klasse_0=Klasse 0 – Anlagevermögen, klasse_1=Klasse 1 – Umlaufvermögen, klasse_2=Klasse 2 – Eigenkapital, klasse_3=Klasse 3 – Fremdkapital, klasse_4=Klasse 4 – Betriebliche Aufwendungen, klasse_5=Klasse 5 – Betriebliche Erträge, klasse_6=Klasse 6 – Weitere Aufwendungen, klasse_7=Klasse 7 – Weitere Erträge, klasse_8=Klasse 8 – Abschlusskonten, klasse_9=Klasse 9 – Vortragskonten\n  "steuerkennung": string | null, // Steuerkennung\n  "skr03_hinweis": string | null, // Hinweis / Beschreibung\n}`;
      ...
      setFields(prev => {
        ...
        return merged as Partial<Skr03Kontenrahmen['fields']>;
      });
      setScanSuccess(true);
  ...
  const DIALOG_INTENT = defaultValues ? 'SKR03-Kontenrahmen bearbeiten' : 'SKR03-Kontenrahmen hinzufügen';
