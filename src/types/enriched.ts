import type { Belegerfassung, Belegpositionen, Beleguebersicht, KontierungUndPruefung, Leasingfahrzeug, UstAbfuehrungLeasingfahrzeug } from './app';
...
export type EnrichedBeleguebersicht = Beleguebersicht & {
  beleg_listeName: string;
  positionen_listeName: string;
};
