...
export const AI_PHOTO_SCAN: Record<string, boolean> = {
  Belegerfassung: true,
  UstAbfuehrungLeasingfahrzeug: true,
  ExportUndAusgabe: true,
  Skr03Kontenrahmen: true,
  Leasingfahrzeug: true,
  KontierungUndPruefung: true,
  Belegpositionen: true,
  Beleguebersicht: true,
};
