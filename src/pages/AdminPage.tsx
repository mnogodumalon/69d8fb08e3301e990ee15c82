...
const BELEGPOSITIONEN_FIELDS = [
  ...
  { key: 'zahlungsart', label: 'Zahlungsart', type: 'lookup/select', options: [{ key: 'bar', label: 'Bar' }, { key: 'paypal', label: 'PayPal' }, { key: 'sonstige_zahlung', label: 'Sonstige' }, { key: 'ueberweisung', label: 'Überweisung' }, { key: 'lastschrift', label: 'Lastschrift' }, { key: 'kreditkarte', label: 'Kreditkarte' }, { key: 'ec_karte', label: 'EC-Karte' }] },
