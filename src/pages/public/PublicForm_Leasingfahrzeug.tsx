...
const PROXY_BASE = '';
const APP_ID = '69db659e5fd46be27d40b8da';
...
export default function PublicFormLeasingfahrzeug() {
    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      <div className="w-full max-w-lg">
        <div className="text-center mb-8">
          <h1 className="text-2xl font-bold text-foreground">Leasingfahrzeug — Formular</h1>
        </div>
